...
#define MGPIOA_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOA_PERIPHERAL_BASE_ADDR)
#define MGPIOB_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOB_PERIPHERAL_BASE_ADDR)
#define MGPIOC_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOC_PERIPHERAL_BASE_ADDR)
#define MGPIOD_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOD_PERIPHERAL_BASE_ADDR)
#define MGPIOE_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOE_PERIPHERAL_BASE_ADDR)
#define MGPIOH_PERIPHERAL ((volatile ST_MGPIOx_RegistersMap_t *)MGPIOH_PERIPHERAL_BASE_ADDR)
